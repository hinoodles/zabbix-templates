...
from aliyunsdkrds.request.v20140815 import DescribeDBInstanceAttributeRequest,DescribeDBInstancesRequest,DescribeResourceUsageRequest,DescribeDBInstancePerformanceRequest
...
def GetDBInstanceStorage(DBInstanceId,Key):
    ...
    DBStorage = (json.loads(DBInstanceStorage))["Items"]["DBInstanceAttribute"][0][Key]
    #print DBStorage
...
if (Type == "DBStorage"):
   GetDBInstanceStorage(DBInstanceId,Key)
